...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{content/figures/nikola_tesla_picuture.jpg}
  \caption{Albert Einstein in 1921\protect\footnotemark}
\end{figure}
\footnotetext{\url{https://en.wikipedia.org/wiki/Nikola_Tesla#/media/File:N.Tesla.JPG}}
